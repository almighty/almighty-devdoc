...
* link:development/planning.html[Planning Process].
* link:development/dod.html[Definitions of Done] (DoD).
* link:development/uximplementation.html[UX Implementation Requirments for Userstories].
