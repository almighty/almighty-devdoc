= Fabric8 services Developer Documentation
...
We are currently on Mattermost (openshiftio room) in `chat.openshift.io`.

Google groups - we have a google group `mailto:fabric8@googlegroups.com[fabric8@googlegroups.com]`.
